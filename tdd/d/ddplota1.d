...
IF ~~ THEN BEGIN 1 // from: 0.2 0.1 0.0
  ...
  IF ~~ THEN REPLY @8 DO ~SetGlobal("destroyself","LOCALS",1)~ EXIT
...
IF ~~ THEN BEGIN 3 // from: 2.0
  ...
  IF ~~ THEN REPLY @13 DO ~SetGlobal("destroyself","LOCALS",1)~ EXIT
END

IF ~~ THEN BEGIN 4 // from: 3.0
  SAY @14
  IF ~~ THEN REPLY @15 DO ~SetGlobal("destroyself","LOCALS",1)~ EXIT
  IF ~Alignment(LastTalkedToBy(),CHAOTIC_NEUTRAL)~ THEN REPLY @16 DO ~SetGlobal("fight","LOCALS",1)~ EXIT
END

IF ~~ THEN BEGIN 5 // from: 0.3
  SAY @17
  IF ~~ THEN DO ~SetGlobal("fight","LOCALS",1)~ EXIT
END
