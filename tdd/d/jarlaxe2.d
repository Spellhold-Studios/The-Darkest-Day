...
IF ~~ THEN BEGIN 11 // from: 10.0 9.1
  SAY @23
  IF ~~ THEN DO ~SetGlobal("jarltask","GLOBAL",1)~ EXIT
END

IF ~PartyHasItem("tootha1")
PartyHasItem("tootha2")
PartyHasItem("tootha3")
Global("jarltask","GLOBAL",1)~ THEN BEGIN 12
  SAY @24 
...
IF ~~ THEN BEGIN 22 // from: 21.0
  SAY @44 
  IF ~~ THEN DO ~SetGlobal("grazztmeeting","GLOBAL",1)
SetGlobal("jarltask","GLOBAL",2)
