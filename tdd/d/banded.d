...
IF ~Global("Bansheeyield","GLOBAL",0)~ THEN BEGIN 0
  SAY @0
...
IF ~~ THEN BEGIN 5 // from: 4.1 4.0
  SAY @12
  IF ~~ THEN DO ~SetGlobal("Bansheeyield","GLOBAL",3)
DestroyItem("MINHP1")
Wait(1)
AddexperienceParty(145000)
Wait(1)
ApplySpell(Myself,WIZARD_FINGER_OF_DEATH_IGNORE_RESISTANCE)~ JOURNAL @50103 EXIT
END
