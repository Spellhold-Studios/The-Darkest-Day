...
!Class(Player6,MAGE_THIEF)~ THEN REPLY @18 DO ~SetGlobal("trolstomach","GLOBAL",1)~ EXIT
  IF ~Class(Player1,MAGE_ALL)~ THEN REPLY @19 DO ~SetGlobal("trollgutcure1","GLOBAL",1)~ EXIT
  IF ~Class(Player2,MAGE_ALL)~ THEN REPLY @20 DO ~SetGlobal("trollgutcure2","GLOBAL",1)~ EXIT
  IF ~Class(Player3,MAGE_ALL)~ THEN REPLY @21 DO ~SetGlobal("trollgutcure3","GLOBAL",1)~ EXIT
  IF ~Class(Player4,MAGE_ALL)~ THEN REPLY @22 DO ~SetGlobal("trollgutcure4","GLOBAL",1)~ EXIT
  IF ~Class(Player5,MAGE_ALL)~ THEN REPLY @23 DO ~SetGlobal("trollgutcure5","GLOBAL",1)~ EXIT
  IF ~Class(Player6,MAGE_ALL)~ THEN REPLY @24 DO ~SetGlobal("trollgutcure6","GLOBAL",1)~ EXIT
END
