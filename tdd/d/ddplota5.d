...
IF ~~ THEN BEGIN 2 // from: 9.2 9.0 1.2 1.0
  SAY @9
  IF ~~ THEN GOTO 3
END

IF ~~ THEN BEGIN 3 // from: 11.0 8.0 2.0
  SAY @10
  IF ~~ THEN GOTO 4
END
...
IF ~~ THEN BEGIN 6 // from: 5.0
  SAY @15
  IF ~~ THEN DO ~SetGlobal("GameActive","ARPO28",1)~ EXIT
END
...
IF ~Global("spawnDDGAME03","ARPO28",1)~ THEN BEGIN 12
  SAY @21
  IF ~~ THEN GOTO 13
END
...
IF ~~ THEN BEGIN 13 // from: 12.0
  SAY @22
  IF ~~ THEN DO ~SetGlobal("spawnDDGAME03","ARPO28",2)
CreateVisualEffectObject("SPDIMNDR",Myself)
Wait(1)
JumpToPoint([2202.810])~ EXIT
END

IF ~Global("spawnDDGAME03","ARPO28",2)~ THEN BEGIN 14
  SAY @23
  IF ~~ THEN GOTO 15
END
