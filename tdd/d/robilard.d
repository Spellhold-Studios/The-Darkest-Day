...
IF ~Global("KnowRobillard","GLOBAL",0)
...
IF ~~ THEN BEGIN 4 // from: 3.0
  SAY @12
  IF ~~ THEN REPLY @13 DO ~SetGlobal("KnowRobillard","GLOBAL",1)~ EXIT
...
IF ~~ THEN BEGIN 8 // from: 7.0
  ...
  IF ~~ THEN REPLY @22 DO ~SetGlobal("KnowRobillard","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN 9 // from: 8.0
  SAY @23
  IF ~~ THEN REPLY @24 GOTO 10
  IF ~~ THEN REPLY @25 DO ~SetGlobal("KnowRobillard","GLOBAL",1)~ EXIT
END
...
IF ~~ THEN BEGIN 13 // from: 11.1
  SAY @32
  IF ~GlobalLT("chapter","GLOBAL",4)~ THEN REPLY @33 GOTO 14
  IF ~GlobalLT("chapter","GLOBAL",4)~ THEN REPLY @34 GOTO 17
...
SetGlobal("KnowRobillard","GLOBAL",1)
...
IF ~~ THEN BEGIN 18 // from: 13.2
  SAY @42
  IF ~~ THEN DO ~SetGlobal("KnowRobillard","GLOBAL",1)
SetGlobal("KickedOut","LOCALS",0)~ EXIT
END
...
IF ~Global("KnowRobillard","GLOBAL",0)~ THEN BEGIN 26
  SAY @57
  IF ~~ THEN REPLY @50 GOTO 1
  IF ~~ THEN REPLY @2 GOTO 1
END

IF ~Global("KnowRobillard","GLOBAL",1)~ THEN BEGIN 27
  SAY @58
...
IF ~~ THEN BEGIN 29 // from: 28.0
  SAY @63
  IF ~GlobalLT("chapter","GLOBAL",4)~ THEN REPLY @33 GOTO 30
  IF ~GlobalLT("chapter","GLOBAL",4)~ THEN REPLY @34 GOTO 33
  IF ~~ THEN REPLY @64 /* #84631 */ DO ~JoinParty()
SetGlobal("KnowRobillard","GLOBAL",2)~ EXIT
END
