...
IF ~~ THEN BEGIN 4 // from: 3.0
  SAY @7
  IF ~~ THEN REPLY @8 DO ~SetGlobal("caliprisonspawn","GLOBAL",1)~ EXIT
  IF ~~ THEN REPLY @9 DO ~SetGlobal("caliprisonspawn","GLOBAL",1)~ EXIT
END
...
IF ~~ THEN BEGIN 20 // from: 19.0
  ...
  IF ~~ THEN REPLY @43 DO ~SetGlobal("pashapassing","GLOBAL",1)
...
TakePartyItem("calheart")
AddExperienceParty(30000)~ EXIT
  IF ~~ THEN REPLY @45 DO ~SetGlobal("pashapassing","GLOBAL",1)
TakePartyItem("calheart")
AddExperienceParty(30000)~ EXIT
END

IF ~Global("pashtravdone","GLOBAL",1)~ THEN BEGIN 22
  SAY @46
...
SetGlobal("pashacircle","GLOBAL",1)~ EXIT
END
